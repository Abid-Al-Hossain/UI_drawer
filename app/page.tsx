...
export default function Page() {
  const [state, setState] = useState<DrawerState>(DEFAULT_DRAWER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Drawer Studio" controls={controls} preview={output} /></AppShell>;
}
