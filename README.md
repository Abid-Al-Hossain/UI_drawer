# UI Foundry Drawer Studio

Standalone visual Drawer generator built with Next.js, React, and TypeScript.

Standalone Drawer component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Drawer UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Drawer generator
...
The editor is focused on controls that are native to Drawer and useful in real product work:
- side, open state, size, overlay, close behavior, header/body/footer, and action slots
- surface, border, shadow, radius, backdrop, spacing, and motion-safe slide behavior
- navigation, settings, cart, filter, and detail drawer archetypes
- focus and dismissal expectations without fake behavior
- React export for drawer layout

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Drawer.
...
This repo is intended to publish as Abid-Al-Hossain/UI_drawer.
